...
if __name__ == '__main__' or True:
    ...
    # load images
    Il = readcolorppm('data/tsukuba/tsconl.ppm')
    Ir = readcolorppm('data/tsukuba/tsconr.ppm')
    Il = Il/255.0
    Ir = Ir/255.0
    # Il = Il*1.0
    # Ir = Ir*1.0
    Limg = cv2.imread('data/tsukuba/tsconl.ppm')/255
    Rimg = cv2.imread('data/tsukuba/tsconr.ppm')/255
...
#
# pfmwrite(final_labels,'test444.pfm');
# iiimg = final_labels;
# end
