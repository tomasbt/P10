...
# fast fast cost volume simulation with ccorr instead of SAD and Grad
...
if __name__ == '__main__' or True:
    ...
    for cr in range (10):
        ...
        print 'time taken', time.time()-start, 'and cr =', cr
        ...
        plt.figure()
        fstr = 'data/res/'+image+'_fcv_corr_noGIF_cr'+str(cr)+'.jpg'
