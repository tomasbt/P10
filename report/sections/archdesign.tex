...
%Torben og Tobias bog: side 149 pdf: Parallel computing\\
%Flynn taxonomy:\\
%SISD: Single Instruction Single Data\\
%SIMD: Single Instruction Multiple Data\\
%MIMD: Multiple Instruction Multiple Data\\
%- SPMD: Single Program MD\\
%- MPMD: Multiple Program MD\\
...
%\Theta_{N-1}
%\end{matrix}  
%\right\rbrace_{tasks} \rightarrow
%\left\lbrace 
%\begin{matrix}
%W_0 \\
%\vdots \\
%W_{M-1}
%\end{matrix}  
%\right\rbrace_{workers} \rightarrow
%\left\lbrace 
%\begin{matrix}
%\Theta_0, \dots, \Theta_{M-1} \\
%\Theta_M, \dots, \Theta_{2M-1} \\
%\vdots \\
%\Theta_{\lfloor N/M \rfloor M}, \dots, \Theta_{N-1} \\
%\end{matrix}  
%\right\rbrace_{results}
%\end{equation}
%Round robin\\
%Amdahl's law:\\
%problem size $\alpha$, $M$ processing units. part of problem is sequential and must be computed first\\
%\begin{equation}
%\mathcal{T}_{a}(\alpha;M) = \mathcal{T}_{a,seq}(\alpha) + \mathcal{T}_{a,par}(\alpha;M)
%\end{equation}
